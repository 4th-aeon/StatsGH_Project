...
const SearchBar = ({ showing = false }) => {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center bg-white px-2 rounded-sm">
          ...
          <svg
            ...
            className={`${
              !spin && "hidden"
            } size-5 text-gray-200 animate-spin fill-[#cc0700]`}
            viewBox="0 0 100 101"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
      ...
      {error && (
        <div className="error-message mx-4 overflow-hidden text-center mt-10 text-xl font-medium shadow text-[#cc0700]">
