    ...
    <main className="block md:hidden sticky top-0 z-30 bg-white">
      ...
      >
        <div className="flex lg:mt-[5%] mt-4 flex-col items-start px-4 py-5 space-y-8">
          <div className="text-[#cc0700] w-full self-center flex items-center justify-between font-bold text-3xl font-EB">
            <p className="flex-grow text-center">StatsGH</p>
          ...
          {!isLoggedIn ? (
            <div className="flex self-end items-center gap-3">
              ...
              <div
                className="bg-[#cc0700] text-white rounded-full px-3 py-2 font-bold text-xs cursor-pointer"
                onClick={(e) => {
                  e.preventDefault();
                  setIsLoginOpen(true);
