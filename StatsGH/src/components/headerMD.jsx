          ...
          <div className="flex flex-wrap justify-between space-x-4 items-center text-lg">
                ...
                {topicData.length > 0 &&
                  topicData.slice(0, 6).map(
                    (topic) =>
                      topic.news_count > 0 && (
                        <Link
                          className="text-nowrap transition-colors duration-700 ease-in-out hover:text-[#cc0700]"
                          key={topic.id}
            ...
            {!isLoggedIn ? (
              <div className="flex self-end items-center gap-3">
                ...
                <div
                  className="bg-[#cc0700] text-white rounded-full px-4 py-2 font-semibold text-sm cursor-pointer"
                  onClick={(e) => {
                    e.preventDefault();
                    setIsLoginOpen(true);
          ...
          <div className="flex  mr-3 flex-col items-start p-5 space-y-4">
            ...
            <div className="ml-9 font-medium">
              ...
              <div className="mt-4 flex items-center gap-2 text-[#666666] transition-colors duration-300">
                <a
                  href="#"
                  className="text-sm font-semibold hover:text-[#cc0700]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={24}
        ...
        {isLoginOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 overflow-y-auto ">
            <div className="bg-white p-6 relative w-11/12 max-w-md max-h-[90vh] overflow-y-auto ">
              <p className="text-[#cc0700] font-EB font-bold text-4xl text-center pt-7 ">
                StatsGH
              </p>
              <button
              ...
              {isCreatingAccount ? (
                ...
                <div>
                  ...
                  <div className="text-[#cc0700] flex justify-between">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <button
                      className="bg-[#cc0700] hover:bg-gray-700 w-full text-white p-3 mt-7 rounded-full"
                      type="submit"
                    >
                ...
                <div>
                  ...
                  <form onSubmit={handleLogin}>
                    ...
                    <button
                      className="rounded-full w-full bg-[#cc0700] mt-6 p-3 text-center text-white"
                      type="submit"
                    >
