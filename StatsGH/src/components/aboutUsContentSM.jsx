    ...
    <>
      <main className="overflow-x-hidden px-3 block md:hidden">
        ...
        <p className="mt-4 leading-relaxed font-EB">
          ...
          statistics into simple, relatable insights. At StatsGH, we believe
          that understanding numbers shouldn’t be a challenge. Our mission is to
          make statistical data meaningful and accessible for everyday
          Ghanaians.
          <br />
          {""}
          ...
          <br />
          {""}
          At StatsGH, numbers tell stories, and we make sure you
          understand them.
        </p>
        {/* Socials */}
        {/* Socials */}
        ...
        <div className="mt-4 flex items-center gap-2 text-[#666666] transition-colors duration-300">
          <a href="#" className="text-sm font-semibold hover:text-[#cc0700]">
            <svg
