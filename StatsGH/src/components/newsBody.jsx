  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="animate-spin rounded-full h-32 w-32 border-t-2 border-b-2 border-[#cc0700]"></div>
      </div>
    );
  }
      ...
      <div className="flex justify-center items-center min-h-screen">
        <div className="text-center">
          ...
          <button
            ...
            className="mt-4 bg-[#cc0700] text-white px-4 py-2 rounded hover:bg-[#cc0700]"
          >
            Try Again
          </button>
        </div>
        ...
        <div className="lg:col-span-2">
          ...
          <div className="md:flex md:justify-between md:items-center md:self-center mt-2 text-[#666666]">
            ...
            <div className="flex pt-2 md:pt-0 gap-3 md:text-xs">
              ...
              <a
                href="#comments"
                className="flex items-center self-center gap-2 text-[#666666] hover:text-[#cc0700] transition-colors duration-300"
              >
